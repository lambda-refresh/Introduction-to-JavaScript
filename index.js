...
function annoyingSong(bottles) {
  if (bottles == 0) {
    return "No more bottles of soda on the wall!";
  } else {
...
//   } else {
//     console.log(
//       `${bottles} bottles of soda on the wall, ${bottles} bottles of soda, take one down pass it around ${
//         bottles - 1
//       } bottles of soda on the wall`
//     );
//     return annoyingSong(bottles - 1);
//   }
// }
